...
#SDL3_mixer
install_name_tool -add_rpath @executable_path/../vendor/SDL3_mixer/macos/lib build/sdl_snake_game
# Correct library reference to match actual file
install_name_tool -change @rpath/libSDL3_mixer.0.dylib @rpath/libSDL3_mixer.0.0.0.dylib build/sdl_snake_game